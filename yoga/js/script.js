...
// Form
    ...
    form.addEventListener("submit", function(event) { ///!!! вешать событие на форму, а не на кнопку
    ...
    let slideIndex = 1,  // индеск текущего слайда
    ...
    function showSlides(n) {
        ...
        // for (let i = 0; i < slides.length; i++) {  //аналогично тому что сверху
